...
namespace Ardex.Util
{
    ...
    /// </summary>
    /// <remarks>
    ///   This is not original work by ARDEX Technology.
    ///   The original class definition is found at
    ///   http://www.codeproject.com/Articles/11016/Numeric-String-Sort-in-C.
    /// </remarks>        
    public class StringLogicalComparer
    {
        /// <summary>
        /// Performs a non-case-sensitive comparison of the
        /// given strings while taking into account any
        /// numeric values detected within either string.
        /// </summary>
