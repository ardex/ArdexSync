...
//        {
//            // Implemented as per Microsoft's specs.
//            var segments = new[] {
//                this.Segment1.AsEnumerable().Reverse(), // Least significant byte first.
//                this.Segment2.AsEnumerable().Reverse(), // Least significant byte first.
//                this.Segment3.AsEnumerable().Reverse(), // Least significant byte first.
//                this.Segment4.AsEnumerable(), // Most significant byte first.
//                this.Segment5.AsEnumerable()  // Most significant byte first.
//            };
